...
<body>
    ...
    ?>
        ...
        <section class="section3">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 wow animate__animated animate__fadeInUp" >
                        <div class="card border-0 mt-5" style="border-radius: 30px;">
                            <div class="card-body border-0 " style="border: 2px groove #75002d;">
                                <i class="fa fa-telegram d-flex justify-content-center" style="color:#75002d;"></i>
                                <h4 class="text-center " style="color:#75002d;">Find Us At</h4>
                                <p class="text-center " style="color:#75002d;">YFIS,Sector 25, NEW DELHI</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6  col-lg-4 col-xl-4 wow animate__animated animate__fadeInUp">
                        <div class="card border-0 mt-5" style="border-radius: 30px;">
                            <div class="card-body border-0 ">
                                <i class="fa-solid fa-envelope d-flex justify-content-center " style="color:#75002d;"></i>
                                <h4 class="text-center " style="color:#75002d;">Mail Us At</h4>
                                <p class="text-center" style="color:#75002d;">yfis@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 wow animate__animated animate__fadeInUp">
                        <div class="card border-0 mt-5" style="border-radius: 30px;">
                            <div class="card-body border-0 ">
                                <i class="fa-solid fa-phone d-flex justify-content-center " style="color:#75002d;"></i>
                                <h4 class="text-center " style="color:#75002d;">Call Us At</h4>
                                <p class="text-center " style="color:#75002d;">0241-6589745610</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-6 col-xl-6 wow animate__animated animate__fadeInUp">
                        <form action="contact_save.php" method="post">
                            <h3 class="text-center" style="color:#75002d;">Get In Touch</h3>
                            <input type="text" name="sname" id="" placeholder="Enter your name*" required class="inp1">
                            <input type="text" name="smobile" id="" placeholder="Enter your mobile number*" required class="inp1">
                            <input type="email" name="semail" id="" placeholder="Enter your email  address*" required class="inp1">
                            <select name="sopinion" id="" class="inp1">
                                <option value="Where did you know about us?">Where did you know about us?</option>
                            ...
                            <textarea name="smessage" id="" cols="30" rows="5" class="inp2" placeholder="Enter your message"></textarea>
                            <button class="btn submit-btn border-0 mt-3">Submit</button>
                        </form>
                    </div>
                    <div class="col-12 col-md-12 col-lg-6 col-xl-6 mt-5 mt-md-0 wow animate__animated animate__fadeInUp ">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d120638.06828970327!2d74.66009990945562!3d19.11030399343299!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdcb05d46788921%3A0x6677e92c1a5181b6!2sAhmednagar%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1708449437861!5m2!1sen!2sin" width="450" height="400" style="margin-top: 50px;  border: 2px groove #75002d; border-radius: 20px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </section>
