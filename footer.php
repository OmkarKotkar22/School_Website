<footer class="footer">
            <div class="container">
                <div class="row ">
                    <div class="col-lg-6 col-xl-4 wow animate__animated animate__fadeInUp">
                    ...
                    <div class="col-lg-6 col-xl-2 d-flex justify-content-center wow animate__animated animate__fadeInUp">
                    ...
                    <div class="col-lg-6 col-xl-4 d-flex justify-content-center wow animate__animated animate__fadeInUp">
                        <div class="address">
                            ...
                            <!-- <h3 class="addr" style="color:#00394F;">Youth Fundation International School <br>Near Ch.Shivaji Park, MG Road, A.nagar 110077</h3> -->
