...
<body>
    ...
    ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 p-0 ">
                        <div class="marquee1">
                            <marquee behavior="scroll" direction="left" class="wow animate__animated animate__zoomIn" style="color:#75002d;"><b>***Admissions open for the session 2024-25***</marquee>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section2">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-xl-6 p-0 parent_image wow animate__animated animate__fadeInLeft">
                        <img src="https://disdwarka.skoolroom.in/uploads/disdwarka/logonew_login.png" alt="" class="sub_img wow animate__animated animate__fadeInLeft">
                    </div>
            
                    <div class="col-lg-12 col-xl-6 p-0 school_about ">
                        <img src="images/logo.png" alt="" class="d-flex justify-content-end wow animate__animated animate__fadeInRight">
                        <h3 class="wow animate__animated animate__fadeInRight" style="color:#75002d;">Welcome to<br>
                            YOUTH FOUNDATION INTERNATIONAL SCHOOL</h3>
                        <p class="wow animate__animated animate__fadeInRight">"Creating global heads with hearts"</p>
                        <form action="parent_login_save.php" method="post">
                            <input type="text" name="semail" placeholder="Email" class="wow animate__animated animate__fadeInRight">
                            <input type="password" name="spassword" placeholder="Password" class="wow animate__animated animate__fadeInRight">
                            <a href="#" class="wow animate__animated animate__fadeInRight">Forgot Password</a>
                            <button type="submit" class="wow animate__animated animate__fadeInRight">Login</button>
                        </form>
                    </div>
                </div>
            </div>
